# Dev log (human): Two-part human dev log
...
| **Date** | 2026-05-23 |
| **Time** | 16-59 |
| **Filename** | `005_2026-05-23_16-59_dev-log_two-part-human-dev-log.md` |
| **Agent audit** | [005_2026-05-23_16-59_dev-log-agent_two-part-human-dev-log.json](../agent/005_2026-05-23_16-59_dev-log-agent_two-part-human-dev-log.json) |
| **Git** | `unknown` @ `unknown` |
...
| Top extensions | .js (226), .md (119), .json (43), .jsx (35), .mjs (33) |
...
│       │   │   ├── prompts/
│       │   │   │   ├── manifest.json
│   └── … (767 more lines — [full tree](#repository-tree-full))
```
